...
public class OrgRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(OrgRegister.this, OrgLogin.class));
            }
        });
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(email.equals("")){
                    ...
                    final ProgressDialog pd = new ProgressDialog(OrgRegister.this);
                    pd.setMessage("Loading...");
                    pd.show();

                    String url = "https://donationapp-f4b46.firebaseio.com/org.json";

                    StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>(){
                        @Override
                        public void onResponse(String s) {
                            Firebase reference = new Firebase("https://donationapp-f4b46.firebaseio.com/org");

                            if(s.equals("null")) {
                                reference.child(email).child("Password").setValue(pass);
                                Toast.makeText(OrgRegister.this, "registration successful", Toast.LENGTH_LONG).show();
                            }
                            else {
                                try {
                                    ...
                                    if (!obj.has(email)) {
                                        ...
                                        Toast.makeText(OrgRegister.this, "user already exists", Toast.LENGTH_LONG).show();
                                    }
                    ...
                    RequestQueue rQueue = Volley.newRequestQueue(OrgRegister.this);
                    rQueue.add(request);
                }
            }
        });
